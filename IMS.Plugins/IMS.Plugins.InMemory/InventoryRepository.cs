...
namespace IMS.Plugins.InMemory
{
    public class InventoryRepository : IInventoryRepository
    {
        ...
        public InventoryRepository()
        {
            ...
            {
                new Inventory { InventoryId = 1, InventoryName = "Laptop", Quantity = 10, Price = 2 },
                new Inventory { InventoryId = 2, InventoryName = "Pc", Quantity = 10, Price = 15 },
                new Inventory { InventoryId = 3, InventoryName = "Smartphone", Quantity = 20, Price = 8 },
                new Inventory { InventoryId = 4, InventoryName = "Tablet", Quantity = 20, Price = 1 },
            };
        }
